...
public class SMSUtils {
    ...
    /*
     * @throws Exception public static String send(String name, String pwd,
     * StringBuffer mobileString, StringBuffer contextString, String sign, String
     * stime, StringBuffer extno) throws Exception {
     */
